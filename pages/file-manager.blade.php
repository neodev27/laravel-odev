...
@section('subhead')
    <title>DOsya Yöneticisi - Midone - Tailwind HTML Yönetici Şablonu</title>
@endsection

@section('subcontent')
    <div class="grid grid-cols-12 gap-6 mt-8">
        <div class="col-span-12 lg:col-span-3 2xl:col-span-2">
            <h2 class="intro-y text-lg font-medium mr-auto mt-2">Dosya Yöneticisi</h2>
            <!-- BEGIN: File Manager Menu -->
            <div class="intro-y box p-5 mt-6">
                <div class="mt-1">
                    <a href="" class="flex items-center px-3 py-2 rounded-md bg-primary text-white font-medium">
                        <i class="w-4 h-4 mr-2" data-lucide="image"></i> Resimler
                    </a>
                    <a href="" class="flex items-center px-3 py-2 mt-2 rounded-md">
                        <i class="w-4 h-4 mr-2" data-lucide="video"></i> Videolar
                    </a>
                    <a href="" class="flex items-center px-3 py-2 mt-2 rounded-md">
                        <i class="w-4 h-4 mr-2" data-lucide="file"></i> Belgeler
                    </a>
                    <a href="" class="flex items-center px-3 py-2 mt-2 rounded-md">
                        <i class="w-4 h-4 mr-2" data-lucide="users"></i> Paylaşılan
                    </a>
                    <a href="" class="flex items-center px-3 py-2 mt-2 rounded-md">
                        <i class="w-4 h-4 mr-2" data-lucide="trash"></i> Çöp Kutusu
                    </a>
                </div>
                <div class="border-t border-slate-200 dark:border-darkmode-400 mt-4 pt-4">
                    ...
                    <a href="" class="flex items-center px-3 py-2 mt-2 rounded-md">
                        <i class="w-4 h-4 mr-2" data-lucide="plus"></i> Yeni Etiket Ekle
                    </a>
                </div>
            </div>
        ...
        <div class="col-span-12 lg:col-span-9 2xl:col-span-10">
            ...
            <div class="intro-y flex flex-col-reverse sm:flex-row items-center">
                            ...
                            <div class="dropdown-content">
                                <div class="grid grid-cols-12 gap-4 gap-y-3 p-3">
                                    <div class="col-span-6">
                                        <label for="input-filter-1" class="form-label text-xs">Dosya Adı</label>
                                        <input id="input-filter-1" type="text" class="form-control flex-1" placeholder="Dosya adı giriniz">
                                    </div>
                                    <div class="col-span-6">
                                        <label for="input-filter-2" class="form-label text-xs">Şununla Paylaşılan</label>
                                    ...
                                    <div class="col-span-6">
                                        <label for="input-filter-4" class="form-label text-xs">Boyut</label>
                ...
                <div class="w-full sm:w-auto flex">
                    <button class="btn btn-primary shadow-md mr-2">Yeni Dosya Yükle</button>
                    <div class="dropdown">
                            ...
                            <ul class="dropdown-content">
                                <li>
                                    <a href="" class="dropdown-item">
                                        <i data-lucide="file" class="w-4 h-4 mr-2"></i> Dosyaları Paylaş
                                    </a>
                                </li>
                                <li>
                                    <a href="" class="dropdown-item">
