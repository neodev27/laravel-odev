...
@section('subhead')
    <title>Düğme - Midone - Tailwind HTML Yönetici Şablonu</title>
@endsection

@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Düğmeler</h2>
    </div>
    <div class="intro-y grid grid-cols-12 gap-6 mt-5">
        <div class="col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Temel Düğmeler</h2>
                ...
                <div id="basic-button" class="p-5">
                    <div class="preview">
                        <button class="btn btn-primary w-24 mr-1 mb-2">Birincil</button>
                        <button class="btn btn-secondary w-24 mr-1 mb-2">İkincil</button>
                        <button class="btn btn-success w-24 mr-1 mb-2">Başarı</button>
                        <button class="btn btn-warning w-24 mr-1 mb-2">Uyarı</button>
                        <button class="btn btn-pending w-24 mr-1 mb-2">Askıda olan</button>
                        <button class="btn btn-danger w-24 mr-1 mb-2">Tehlike</button>
                        <button class="btn btn-dark w-24 mr-1 mb-2">Karanlık</button>
                    </div>
                        ...
                        <div class="overflow-y-auto mt-3 rounded-md">
                            <pre id="copy-elevated-button" class="source-preview">
                                <code class="html">
                                    {{ str_replace('>', 'HTMLCloseTag', str_replace('<', 'HTMLOpenTag', '
                                        <div>
                                            <button class="btn btn-elevated-primary w-24 mr-1 mb-2">Birincil</button>
                                            <button class="btn btn-elevated-secondary w-24 mr-1 mb-2">İkincil</button>
                                            <button class="btn btn-elevated-success w-24 mr-1 mb-2">Başarı</button>
                                            <button class="btn btn-elevated-warning w-24 mr-1 mb-2">Uyarı</button>
                                            <button class="btn btn-elevated-pending w-24 mr-1 mb-2">Askıda Olan</button>
                                            <button class="btn btn-elevated-danger w-24 mr-1 mb-2">Tehlike</button>
                                            <button class="btn btn-elevated-dark w-24 mr-1 mb-2">Karanlık</button>
                                        </div>
                                        <div class="mt-5">
                                            <button class="btn btn-elevated-rounded-primary w-24 mr-1 mb-2">Birincil</button>
                                            <button class="btn btn-elevated-rounded-secondary w-24 mr-1 mb-2">İkincil</button>
                                            <button class="btn btn-elevated-rounded-success w-24 mr-1 mb-2">Başarı</button>
                                            <button class="btn btn-elevated-rounded-warning w-24 mr-1 mb-2">Uyarı</button>
                                            <button class="btn btn-elevated-rounded-pending w-24 mr-1 mb-2">Askıda Olan</button>
                                            <button class="btn btn-elevated-rounded-danger w-24 mr-1 mb-2">Tehlike</button>
                                            <button class="btn btn-elevated-rounded-dark w-24 mr-1 mb-2">Karanlık</button>
                                        </div>
                                    ')) }}
                                </code>
                            </pre>
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Sosyal Medya Düğmeleri</h2>
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
        ...
        <div class="col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Anahat Düğmeleri</h2>
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                ...
                <div id="outline-button" class="p-5">
                    <div class="preview">
                        <button class="btn btn-outline-primary w-24 inline-block mr-1 mb-2">Birincil</button>
                        <button class="btn btn-outline-secondary w-24 inline-block mr-1 mb-2">İkincil</button>
                        <button class="btn btn-outline-success w-24 inline-block mr-1 mb-2">Başarı</button>
                        <button class="btn btn-outline-warning w-24 inline-block mr-1 mb-2">Uyarı</button>
                        <button class="btn btn-outline-pending w-24 inline-block mr-1 mb-2">Askıda Olan</button>
                        <button class="btn btn-outline-danger w-24 inline-block mr-1 mb-2">Tehlike</button>
                        <button class="btn btn-outline-dark w-24 inline-block mr-1 mb-2">Karanlık</button>
                    </div>
                    <div class="source-code hidden">
                            ...
                            <pre id="copy-outline-button" class="source-preview">
                                <code class="html">
                                    {{ str_replace('>', 'HTMLCloseTag', str_replace('<', 'HTMLOpenTag', '
                                        ...
                                        <button class="btn btn-outline-warning w-24 inline-block mr-1 mb-2">Uyarı</button>
                                        <button class="btn btn-outline-pending w-24 inline-block mr-1 mb-2">Askıda Olan</button>
                                        <button class="btn btn-outline-danger w-24 inline-block mr-1 mb-2">Tej-hlike</button>
                                        <button class="btn btn-outline-dark w-24 inline-block mr-1 mb-2">Karanlık</button>
                                    ')) }}
                                </code>
                            </pre>
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">"Yükleniyor" Durum Düğmeleri</h2>
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                ...
                <div id="loading-button" class="p-5">
                    <div class="preview">
                        <button class="btn btn-primary mr-1 mb-2">
                            Kaydediliyor <i data-loading-icon="oval" data-color="white" class="w-4 h-4 ml-2"></i>
                        </button>
                        <button class="btn btn-success mr-1 mb-2">
                            Ekleniyor <i data-loading-icon="spinning-circles" data-color="white" class="w-4 h-4 ml-2"></i>
                        </button>
                        <button class="btn btn-warning mr-1 mb-2">
                            Yükleniyor <i data-loading-icon="three-dots" data-color="1a202c" class="w-4 h-4 ml-2"></i>
                        </button>
                        <button class="btn btn-danger mr-1 mb-2">
                            Siliniyor <i data-loading-icon="puff" data-color="white" class="w-4 h-4 ml-2"></i>
                        </button>
                    </div>
                    <div class="source-code hidden">
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Yuvarlatılmış Düğmeler</h2>
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                ...
                <div id="rounded-button" class="p-5">
                    <div class="preview">
                        <button class="btn btn-rounded-primary w-24 mr-1 mb-2">Birincil</button>
                        <button class="btn btn-rounded-secondary w-24 mr-1 mb-2">İkincil</button>
                        <button class="btn btn-rounded-success w-24 mr-1 mb-2">Başarı</button>
                        <button class="btn btn-rounded-warning w-24 mr-1 mb-2">Uyarı</button>
                        <button class="btn btn-rounded-pending w-24 mr-1 mb-2">Askıda Olan</button>
                        <button class="btn btn-rounded-danger w-24 mr-1 mb-2">Tehlike</button>
                        <button class="btn btn-rounded-dark w-24 mr-1 mb-2">Karanlık</button>
                    </div>
                    <div class="source-code hidden">
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Yumuşak Renkli Düğmeler</h2>
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                ...
                <div id="softcolor-button" class="p-5">
                    <div class="preview">
                        <button class="btn btn-rounded btn-primary-soft w-24 mr-1 mb-2">Birincil</button>
                        <button class="btn btn-rounded btn-secondary-soft w-24 mr-1 mb-2">İkincil</button>
                        <button class="btn btn-rounded btn-success-soft w-24 mr-1 mb-2">Başarı</button>
                        <button class="btn btn-rounded btn-warning-soft w-24 mr-1 mb-2">Uyarı</button>
                        <button class="btn btn-rounded btn-pending-soft w-24 mr-1 mb-2">Askıda Olan</button>
                        <button class="btn btn-rounded btn-danger-soft w-24 mr-1 mb-2">Tehlike</button>
                        <button class="btn btn-rounded btn-dark-soft w-24 mr-1 mb-2">Karanlık</button>
                    </div>
                    <div class="source-code hidden">
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Simge Düğmeleri</h2>
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                    ...
                    <div class="preview">
                        <div class="flex flex-wrap">
                            <button class="btn btn-primary w-32 mr-2 mb-2">
                                <i data-lucide="activity" class="w-4 h-4 mr-2"></i>  Aktivite
                            </button>
                            <button class="btn btn-secondary w-32 mr-2 mb-2">
                                <i data-lucide="hard-drive" class="w-4 h-4 mr-2"></i> Hard Disk
                            </button>
                            <button class="btn btn-success w-32 mr-2 mb-2">
                                <i data-lucide="calendar" class="w-4 h-4 mr-2"></i> Takvim
                            </button>
                            <button class="btn btn-warning w-32 mr-2 mb-2">
                                <i data-lucide="share-2" class="w-4 h-4 mr-2"></i> Paylaş
                            </button>
                            <button class="btn btn-pending w-32 mr-2 mb-2">
                                <i data-lucide="download" class="w-4 h-4 mr-2"></i> Askıya Alma
                            </button>
                            <button class="btn btn-danger w-32 mr-2 mb-2">
                                <i data-lucide="trash" class="w-4 h-4 mr-2"></i> Çöp
                            </button>
                            <button class="btn btn-dark w-32 mr-2 mb-2">
                                <i data-lucide="image" class="w-4 h-4 mr-2"></i> Resim
                            </button>
                        </div>
                    </div>
                    <div class="source-code hidden">
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Sadece Resim Butonları</h2>
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
