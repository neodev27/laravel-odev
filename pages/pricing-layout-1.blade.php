...
@section('subhead')
    <title>Ücretlendirme - Midone - Tailwind HTML Yönetici Şablonu</title>
@endsection

@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Ücretlendirme Görünümü</h2>
    </div>
    ...
    <div class="intro-y box flex flex-col lg:flex-row mt-5">
        <div class="intro-y flex-1 px-5 py-16">
            ...
            <div class="text-xl font-medium text-center mt-10">Temel Plan</div>
            <div class="text-slate-600 dark:text-slate-500 text-center mt-5">
            1 Alan Adı <span class="mx-1">•</span> 10 Kullanıcı <span class="mx-1">•</span> 20 Kopya
            </div>
            ...
            <button type="button" class="btn btn-rounded-primary py-3 px-4 block mx-auto mt-8">ŞİMDİ SATIN AL</button>
        </div>
        <div class="intro-y border-b border-t lg:border-b-0 lg:border-t-0 flex-1 p-5 lg:border-l lg:border-r border-slate-200/60 dark:border-darkmode-400 py-16">
            ...
            <div class="text-xl font-medium text-center mt-10">İşletme</div>
            <div class="text-slate-600 dark:text-slate-500 text-center mt-5">
                1 Alan Adı <span class="mx-1">•</span> 10 Kullanıcı <span class="mx-1">•</span> 20 Kopya
            </div>
            <div class="text-slate-500 px-10 text-center mx-auto mt-2">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</div>
        ...
        <div class="intro-y flex-1 px-5 py-16">
            ...
            <div class="text-xl font-medium text-center mt-10">Kurumsal</div>
            <div class="text-slate-600 dark:text-slate-500 text-center mt-5">
                1 Alan Adı <span class="mx-1">•</span> 10 Kullanıcı <span class="mx-1">•</span> 20 Kopya
            </div>
            <div class="text-slate-500 px-10 text-center mx-auto mt-2">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</div>
