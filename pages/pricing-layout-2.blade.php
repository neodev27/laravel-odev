...
@section('subhead')
    <title>Pricing - Midone - Tailwind HTML Yönetici Şablonu</title>
@endsection

@section('subcontent')
    <h2 class="intro-y text-2xl font-medium mt-10 text-center mr-auto">En İy Fiyat ve Servisler</h2>
    <!-- BEGIN: Pricing Tab -->
        ...
        <div class="tab-content">
            <div id="layout-1-monthly-fees" class="tab-pane flex flex-col lg:flex-row active" role="tabpanel" aria-labelledby="layout-1-monthly-fees-tab">
                <div class="intro-y flex justify-center flex-col flex-1 text-center sm:px-10 lg:px-5 pb-10 lg:pb-0">
                    <div class="font-medium text-lg">Aylık Ürün Ücretlendirmesi</div>
