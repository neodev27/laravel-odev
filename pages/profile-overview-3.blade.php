...
@section('subhead')
    <title>Profil - Midone - Tailwind HTML Admin Template</title>
@endsection

@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Profil Görünümü</h2>
    </div>
            ...
            <div class="intro-y box mt-5 lg:mt-0">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu w-56">
                            <ul class="dropdown-content">
                                <li>
                                    <h6 class="dropdown-header">Seçenekleri Çıkar</h6>
                                </li>
                                <li>
                                ...
                                <li>
                                    <div class="flex p-1">
                                        ...
                                        <button type="button" class="btn btn-secondary py-1 px-2 ml-auto">Profili Göster</button>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="p-5 border-t border-slate-200/60 dark:border-darkmode-400">
                    <a class="flex items-center text-primary font-medium" href="">
                        <i data-lucide="activity" class="w-4 h-4 mr-2"></i> Kişisel Bilgi
                    </a>
                ...
                <div class="p-5 border-t border-slate-200/60 dark:border-darkmode-400">
                    ...
                    <a class="flex items-center mt-5" href="">
                        <i data-lucide="settings" class="w-4 h-4 mr-2"></i> Vergi Bilgilendirmeleri
                    </a>
                </div>
                <div class="p-5 border-t border-slate-200/60 dark:border-darkmode-400 flex">
                    <button type="button" class="btn btn-primary py-1 px-2">Yeni Grup</button>
                    <button type="button" class="btn btn-outline-secondary py-1 px-2 ml-auto">Yeni Kolay Bağlantı</button>
                </div>
            </div>
            <div class="intro-y box p-5 bg-primary text-white mt-5">
                <div class="flex items-center">
                    <div class="font-medium text-lg">Önemli Güncelleme</div>
                ...
                <div class="font-medium flex mt-5">
                    <button type="button" class="btn py-1 px-2 border-white text-white dark:text-slate-300 dark:bg-darkmode-400 dark:border-darkmode-400">Hareketi Al</button>
                    <button type="button" class="btn py-1 px-2 border-transparent text-white dark:border-transparent ml-auto">Reddet</button>
                </div>
            </div>
        </div>
        <!-- END: Profile Menu -->
            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="intro-y box col-span-12 2xl:col-span-6">
                    <div class="flex items-center px-5 py-5 sm:py-3 border-b border-slate-200/60 dark:border-darkmode-400">
                        <h2 class="font-medium text-base mr-auto">Günlük Satışlar</h2>
                                ...
                                <ul class="dropdown-content">
                                    <li>
                                        <a href="javascript:;" class="dropdown-item">
                                            <i data-lucide="file" class="w-4 h-4 mr-2"></i> Excel İndir
                                        </a>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="intro-y box col-span-12 2xl:col-span-6">
                    <div class="flex items-center px-5 py-3 border-b border-slate-200/60 dark:border-darkmode-400">
                        <h2 class="font-medium text-base mr-auto">Duyurular</h2>
                    ...
                    <div class="tiny-slider py-5" id="announcement">
                        <div class="px-5">
                            ...
                            <div class="flex items-center mt-5">
                                ...
                                <button class="btn btn-secondary ml-auto">Detayları Görüntüle</button>
                            </div>
                        </div>
                        <div class="px-5">
                            <div class="font-medium text-lg">Midone Admin Template</div>
                ...
                <div class="intro-y box col-span-12 2xl:col-span-6">
                    <div class="flex items-center px-5 py-3 border-b border-slate-200/60 dark:border-darkmode-400">
                        <h2 class="font-medium text-base mr-auto">Projeler</h2>
                        ...
                        <div class="px-5">
                            ...
                            <div class="mt-5">
                                <div class="flex text-slate-500">
                                    <div class="mr-auto">Askıya Alınmış Görevler</div>
                                    <div>20%</div>
                                </div>
                ...
                <div class="intro-y box col-span-12 2xl:col-span-6">
                    <div class="flex items-center px-5 py-3 border-b border-slate-200/60 dark:border-darkmode-400">
                        <h2 class="font-medium text-base mr-auto">Günün Programları</h2>
                    ...
                    <div class="tiny-slider py-5" id="today-schedule">
                        ...
                        <div class="px-5 text-center sm:text-left">
                            ...
                            <div class="flex flex-col sm:flex-row items-center mt-5">
                                ...
                                <button class="btn btn-secondary py-1 px-2 sm:ml-auto mt-3 sm:mt-0sm:ml-auto mt-3 sm:mt-0">Haritada Görüntüle</button>
                            </div>
                        </div>
                        <div class="px-5 text-center sm:text-left">
                            <div class="font-medium text-lg">Developing rest API with Laravel 7</div>
                        ...
                        <div class="dropdown ml-auto">
                            ...
                            <div class="dropdown-menu w-40">
                                <ul class="dropdown-content">
                                    <li>
                                        <a href="" class="dropdown-item">
                                            <i data-lucide="edit-2" class="w-4 h-4 mr-2"></i> Yeni Sohbet
                                        </a>
                                    </li>
                                    <li>
                                        <a href="" class="dropdown-item">
                                            <i data-lucide="trash" class="w-4 h-4 mr-2"></i> Sil
                                        </a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="flex items-center px-5 py-5 sm:py-0 border-b border-slate-200/60 dark:border-darkmode-400">
                        ...
                        <div class="dropdown ml-auto sm:hidden">
                            ...
                            <div class="nav nav-tabs dropdown-menu w-40" role="tablist">
                                <ul class="dropdown-content">
                                    <li>
                                        <a id="work-in-progress-mobile-new-tab" href="javascript:;" data-tw-toggle="tab" data-tw-target="#work-in-progress-new" class="dropdown-item" role="tab" aria-controls="work-in-progress-new" aria-selected="true">Yeni</a>
                                    </li>
                                    <li>
                                        <a id="work-in-progress-mobile-last-week-tab" href="javascript:;" data-tw-toggle="tab" data-tw-target="#work-in-progress-last-week" class="dropdown-item" role="tab" aria-selected="false">Geçen Hafta</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="p-5">
                        <div class="tab-content">
                            <div id="work-in-progress-new" class="tab-pane active" role="tabpanel" aria-labelledby="work-in-progress-new-tab">
                                ...
                                <div class="mt-5">
                                    <div class="flex">
                                        <div class="mr-auto">Tamamlşanmış Görevler</div>
                                        <div>2 / 20</div>
                                    </div>
                                    <div class="progress h-1 mt-2">
                                ...
                                <div class="mt-5">
                                    <div class="flex">
                                        <div class="mr-auto">Süreçteki Görevler</div>
                                        <div>42</div>
                                    </div>
                                    <div class="progress h-1 mt-2">
                                        <div class="progress-bar w-3/4 bg-primary" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                ...
                                <div class="mt-5">
                                    <div class="flex">
                                        <div class="mr-auto">Ön Gösterimdeki Görevler</div>
                                        <div>70%</div>
                                    </div>
                                    <div class="progress h-1 mt-2">
                                ...
                                <a href="" class="btn btn-secondary block w-40 mx-auto mt-5">Daha Fazla Detay Göster</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="intro-y box col-span-12 2xl:col-span-6">
                    <div class="flex items-center px-5 py-5 sm:py-0 border-b border-slate-200/60 dark:border-darkmode-400">
                        <h2 class="font-medium text-base mr-auto">En son görevler</h2>
                        <div class="dropdown ml-auto sm:hidden">
                            <a class="dropdown-toggle w-5 h-5 block" href="javascript:;" aria-expanded="false" data-tw-toggle="dropdown">
                                <i data-lucide="more-horizontal" class="w-5 h-5 text-slate-500"></i>
                            </a>
                            <div class="nav nav-tabs dropdown-menu w-40" role="tablist">
                                <ul class="dropdown-content">
                                    <li>
                                        <a id="latest-tasks-mobile-new-tab" href="javascript:;" data-tw-toggle="tab" data-tw-target="#latest-tasks-new" class="dropdown-item" role="tab" aria-controls="latest-tasks-new" aria-selected="true">Yeni</a>
                                    </li>
                                    <li>
                                        <a id="latest-tasks-mobile-last-week-tab" href="javascript:;" data-tw-toggle="tab" data-tw-target="#latest-tasks-last-week" class="dropdown-item" role="tab" aria-selected="false">Geçen Hafta</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="p-5">
                        <div class="tab-content">
                            <div id="latest-tasks-new" class="tab-pane active" role="tabpanel" aria-labelledby="latest-tasks-new-tab">
                                ...
                                <div class="flex items-center mt-5">
                                    <div class="border-l-2 border-primary dark:border-primary pl-4">
                                        <a href="" class="font-medium">Müşteriyle Görüşme</a>
                                ...
                                <div class="flex items-center mt-5">
                                    <div class="border-l-2 border-primary dark:border-primary pl-4">
                                        <a href="" class="font-medium">Yeni Depo Oluştur</a>
                ...
                <div class="intro-y box col-span-12 2xl:col-span-6">
                    <div class="flex items-center px-5 py-5 sm:py-3 border-b border-slate-200/60 dark:border-darkmode-400">
                        <h2 class="font-medium text-base mr-auto">Genel İstatistikler</h2>
                        <div class="dropdown ml-auto">
