...
@section('subcontent')
    ...
    <div class="grid grid-cols-12 gap-6">
            ...
            <div class="box mt-5">
                <div class="px-4 pb-3 pt-5">
                    <a class="flex rounded-lg items-center px-4 py-2 bg-primary text-white font-medium" href="">
                        ...
                        <div class="flex-1 truncate">Ürünlerimiz Hakkında</div>
                    </a>
                    <a class="flex items-center px-4 py-2 mt-1" href="">
                        <i data-lucide="box" class="w-4 h-4 mr-2"></i>
                        <div class="flex-1 truncate">İlgili Lisans</div>
                    </a>
                    <a class="flex items-center px-4 py-2 mt-1" href="">
                        <i data-lucide="lock" class="w-4 h-4 mr-2"></i>
                        <div class="flex-1 truncate">Tekil Uygulama Lisansı</div>
                    </a>
                    <a class="flex items-center px-4 py-2 mt-1" href="">
                        <i data-lucide="settings" class="w-4 h-4 mr-2"></i>
                        <div class="flex-1 truncate">Çoğul Uygulama Lisansı</div>
                    </a>
                </div>
                <div class="px-4 py-3 border-t border-slate-200/60 dark:border-darkmode-400">
                    <a class="flex items-center px-4 py-2" href="">
                        <i data-lucide="activity" class="w-4 h-4 mr-2"></i>
                        <div class="flex-1 truncate">Kullanım Koşulu</div>
                    </a>
                    <a class="flex items-center px-4 py-2 mt-1" href="">
                        <i data-lucide="box" class="w-4 h-4 mr-2"></i>
                        <div class="flex-1 truncate">Onaylayıcı Ücreti</div>
                    </a>
                    <a class="flex items-center px-4 py-2 mt-1" href="">
                        <i data-lucide="lock" class="w-4 h-4 mr-2"></i>
                        <div class="flex-1 truncate">Ürün Önizlemesi</div>
                    </a>
                    <a class="flex items-center px-4 py-2 mt-1" href="">
                        <i data-lucide="settings" class="w-4 h-4 mr-2"></i>
                        <div class="flex-1 truncate">Gizlilik Politikası</div>
                    </a>
                </div>
        ...
        <div class="intro-y col-span-12 lg:col-span-8 xl:col-span-9">
                    ...
                    <div class="accordion-item">
                        <div id="faq-accordion-content-2" class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-tw-toggle="collapse" data-tw-target="#faq-accordion-collapse-2" aria-expanded="false" aria-controls="faq-accordion-collapse-2">
                                IP Adreslerini, Alt Ağları ve CIDR Gösterimlerini Anlama
                            </button>
                        </div>
            ...
            <div class="intro-y box mt-5">
                <div class="flex items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Çoğul Uygulama Lisansı</h2>
                </div>
