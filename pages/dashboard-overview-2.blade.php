            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 mt-6 -mb-6 intro-y">
                    <div class="alert alert-dismissible show box bg-primary text-white flex items-center mb-6" role="alert">
                        <span>Karşınızda yeni panel! Hemen şuradan indirin: <a href="https://themeforest.net/item/midone-jquery-tailwindcss-html-admin-template/26366820" class="underline ml-1" target="blank">themeforest.net</a>.</span>
                ...
                <div class="col-span-12 lg:col-span-8 xl:col-span-6 mt-2">
                    <div class="intro-y block sm:flex items-center h-10">
                        ...
                        <select class="sm:ml-auto mt-3 sm:mt-0 sm:w-auto form-select box">
                            ...
                            <option value="custom-date">Tarih Ayarla</option>
                        </select>
                    </div>
                    <div class="report-box-2 intro-y mt-12 sm:mt-5">
                        <div class="box sm:flex">
                            <div class="px-8 py-12 flex flex-col justify-center flex-1">
                                ...
                                <div class="mt-4 text-slate-500">Bu ay ilgili yetkili ücretlerinden sonra ve vergilerden önce satış kazançları .</div>
                            ...
                            <div class="px-8 py-12 flex flex-col justify-center flex-1 border-t sm:border-t-0 sm:border-l border-slate-200 dark:border-darkmode-300 border-dashed">
                                <div class="text-slate-500 text-xs">TOPLAM İŞLEM</div>
                                ...
                                <div class="text-slate-500 text-xs mt-5">İPTAL DAVASI</div>
                                <div class="mt-1.5 flex items-center">
                                ...
                                <div class="text-slate-500 text-xs mt-5">BRÜT KİRA DEĞERİ</div>
                                <div class="mt-1.5 flex items-center">
                                ...
                                <div class="text-slate-500 text-xs mt-5">BRÜT KİRA KARI</div>
                                <div class="mt-1.5 flex items-center">
                                ...
                                <div class="text-slate-500 text-xs mt-5">YENİ KULLANICILAR</div>
                                <div class="mt-1.5 flex items-center">
                ...
                <div class="col-span-12 sm:col-span-6 lg:col-span-4 xl:col-span-3 mt-2">
                    <div class="intro-y flex items-center h-10">
                        ...
                        <a href="" class="ml-auto text-primary truncate">Harita'da görüntüle</a>
                    </div>
                    <div class="report-box-2 intro-y mt-5">
                        <div class="box p-5">
                                        ...
                                        <ul class="dropdown-content">
                                            <li>
                                                <a href="" class="dropdown-item">
                                                    <i data-lucide="file-text" class="w-4 h-4 mr-2"></i> Dışa Aktar
                                                </a>
                                            </li>
                                            <li>
                                                <a href="" class="dropdown-item">
                            ...
                            <div class="text-slate-500 text-xs border-b border-slate-200 flex mb-2 pb-2 mt-4">
                                <div>Top Aktif Sayfalar</div>
                                <div class="ml-auto">Aktif Kullanıcılar</div>
                            </div>
                            <div class="flex">
                            ...
                            <button class="btn btn-outline-secondary border-dashed w-full py-1 px-2 mt-4">Gerçek-Zamanlı Bildiri</button>
                        </div>
                    </div>
                </div>
                <!-- END: Visitors -->
                ...
                <div class="col-span-12 sm:col-span-6 lg:col-span-4 xl:col-span-3 mt-2 lg:mt-6 xl:mt-2">
                    <div class="intro-y flex items-center h-10">
                        <h2 class="text-lg font-medium truncate mr-5">Yaş itibariyle Kullanıcılar</h2>
                ...
                <div class="col-span-12 lg:col-span-6 mt-6">
                    <div class="box p-8 relative overflow-hidden bg-primary intro-y">
                        <div class="leading-[2.15rem] w-full sm:w-72 text-white text-xl -mt-3">Lender'in Fon Hesabı ile Güvenli İşlem yap.</div>
                        <div class="w-full sm:w-72 leading-relaxed text-white/70 dark:text-slate-500 mt-3">Şimdi Başvur, hızlı kayıt.</div>
                        <button class="btn w-32 bg-white dark:bg-darkmode-800 dark:text-white mt-6 sm:mt-10">Şimdi Başla</button>
                ...
                <div class="col-span-12 lg:col-span-6 mt-6">
                    <div class="box p-8 relative overflow-hidden intro-y">
                        <div class="leading-[2.15rem] w-full sm:w-52 text-primary dark:text-white text-xl -mt-3"> <span class="font-medium">BEDAVA</span>bonus kazanmak için arkadaşlarınızı davet edin!</div>
                        <div class="w-full sm:w-60 leading-relaxed text-slate-500 mt-2">Arkadaşlarınızı para yatırmaya davet ederek 100,000 IDR kuponu alın #BecomeMember</div>
