...
@section('subhead')
    <title>Takvim - Midone - Tailwind HTML Yönetici Şablonu</title>
@endsection

@section('subcontent')
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Takvim</h2>
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <button class="btn btn-primary shadow-md mr-2">Programı Yazdır</button>
        ...
        <div class="col-span-12 xl:col-span-4 2xl:col-span-3">
            <div class="box p-5 intro-y">
                <button type="button" class="btn btn-primary w-full mt-2">
                    <i class="w-4 h-4 mr-2" data-lucide="edit-3"></i> Yeni Program Ekle
                </button>
                        ...
                        <div class="event p-3 -mx-3 cursor-pointer transition duration-300 ease-in-out hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md flex items-center">
                            ...
                            <div class="pr-10">
                                ...
                                <div class="text-slate-500 text-xs mt-0.5">
                                    <span class="event__days">2</span> Günler <span class="mx-1">•</span> 10:00 AM
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="relative">
                        <div class="event p-3 -mx-3 cursor-pointer transition duration-300 ease-in-out hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md flex items-center">
                            ...
                            <div class="pr-10">
                                ...
                                <div class="text-slate-500 text-xs mt-0.5">
                                    <span class="event__days">3</span> Günler <span class="mx-1">•</span> 07:00 AM
                                </div>
                            </div>
                        </div>
                        <a class="flex items-center absolute top-0 bottom-0 my-auto right-0" href="">
                    ...
                    <div class="relative">
                        <div class="event p-3 -mx-3 cursor-pointer transition duration-300 ease-in-out hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md flex items-center">
                            ...
                            <div class="pr-10">
                                ...
                                <div class="text-slate-500 text-xs mt-0.5">
                                    <span class="event__days">4</span> Günler  <span class="mx-1">•</span> 11:00 AM
                                </div>
                            </div>
                        </div>
                        <a class="flex items-center absolute top-0 bottom-0 my-auto right-0" href="">
            ...
            <div class="box p-5 intro-y mt-5">
                ...
                <div class="border-t border-slate-200/60 dark:border-darkmode-400 pt-5 mt-5">
                    <div class="flex items-center">
                        <div class="w-2 h-2 bg-pending rounded-full mr-3"></div>
                        <span class="truncate">Bağımsızlık günü</span>
                    ...
                    <div class="flex items-center mt-4">
                        ...
                        <span class="truncate">Anma Günü</span>
                        <div class="h-px flex-1 border border-r border-dashed border-slate-200 mx-3 xl:hidden"></div>
