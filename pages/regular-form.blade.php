...
@section('subhead')
    <title>Sıradan Form - Midone - Tailwind HTML Admin Template</title>
@endsection
        ...
        <div class="intro-y col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Giriş</h2>
                ...
                <div id="input" class="p-5">
                    <div class="preview">
                        <div>
                            ...
                            <input id="regular-form-1" type="text" class="form-control" placeholder="Giriş Yazısı">
                        </div>
                        <div class="mt-3">
                            <label for="regular-form-2" class="form-label">Rounded</label>
                            <input id="regular-form-2" type="text" class="form-control form-control-rounded" placeholder="Yuvarlatılmış">
                        </div>
                        <div class="mt-3">
                            <label for="regular-form-3" class="form-label">With Help</label>
                            <input id="regular-form-3" type="text" class="form-control" placeholder="Yardımla">
                        ...
                        <div class="mt-3">
                            ...
                            <input id="regular-form-4" type="password" class="form-control" placeholder="Şifre">
                        </div>
                        <div class="mt-3">
                            <label for="regular-form-5" class="form-label">Disabled</label>
                            <input id="regular-form-5" type="text" class="form-control" placeholder="Devre Dışı Bırakılmış" disabled>
                        </div>
                    </div>
                            ...
                            <pre id="copy-input" class="source-preview">
                                <code class="html">
                                    {{ str_replace('>', 'HTMLCloseTag', str_replace('<', 'HTMLOpenTag', '
                                        ...
                                        <div class="mt-3">
                                            <label for="regular-form-3" class="form-label">With Help</label>
                                            <input id="regular-form-3" type="text" class="form-control" placeholder="Yardım ile">
                                            <div class="form-help">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</div>
                                        </div>
                                        <div class="mt-3">
                                            <label for="regular-form-4" class="form-label">Password</label>
                                            <input id="regular-form-4" type="password" class="form-control" placeholder="Şİfre">
                                        </div>
                                        <div class="mt-3">
                                            <label for="regular-form-5" class="form-label">Disabled</label>
                                            <input id="regular-form-5" type="text" class="form-control" placeholder="Devre dışı bırakılmış" disabled>
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Giriş Boyutlandırma</h2>
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Giriş Grupları</h2>
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                ...
                <div id="input-groups" class="p-5">
                    <div class="preview">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="E-Posta" aria-label="Email" aria-describedby="input-group-email">
                        </div>
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" placeholder="Fiyat" aria-label="Price" aria-describedby="input-group-price">
                            <div id="input-group-price" class="input-group-text">.00</div>
                        </div>
                        <div class="input-group mt-2">
                            <div class="input-group-text">@</div>
                            <input type="text" class="form-control" placeholder="Fiyat" aria-label="Amount (to the nearest dollar)">
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Giriş Durumu</h2>
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                ...
                <div id="input-state" class="p-5">
                    <div class="preview">
                        <div>
                            ...
                            <input id="input-state-1" type="text" class="form-control border-success" placeholder="Giriş Yazısı">
                        ...
                        <div class="mt-3">
                            ...
                            <input id="input-state-2" type="text" class="form-control border-warning" placeholder="Giriş Yazısı">
                        ...
                        <div class="mt-3">
                            ...
                            <input id="input-state-3" type="text" class="form-control border-danger" placeholder="Giriş Yazısı">
        ...
        <div class="intro-y col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box">
                ...
                <div id="vertical-form" class="p-5">
                    <div class="preview">
                        <div>
                            <label for="vertical-form-1" class="form-label">E-Posta</label>
                            <input id="vertical-form-1" type="text" class="form-control" placeholder="example@gmail.com">
                        </div>
                        <div class="mt-3">
                            <label for="vertical-form-2" class="form-label">Şifre</label>
                        ...
                        <div class="form-check mt-5">
                            ...
                            <label class="form-check-label" for="vertical-form-3">Beni Hatırla</label>
                        </div>
                        <button class="btn btn-primary mt-5">Giriş Yap</button>
                    </div>
                    <div class="source-code hidden">
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Yatay Form</h2>
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                ...
                <div id="horizontal-form" class="p-5">
                    <div class="preview">
                        <div class="form-inline">
                            <label for="horizontal-form-1" class="form-label sm:w-20">E-Posta</label>
                            <input id="horizontal-form-1" type="text" class="form-control" placeholder="example@gmail.com">
                        </div>
                        <div class="form-inline mt-5">
                            <label for="horizontal-form-2" class="form-label sm:w-20">Şifre</label>
                        ...
                        <div class="form-check sm:ml-20 sm:pl-5 mt-5">
                            ...
                            <label class="form-check-label" for="horizontal-form-3">Beni Hatırla</label>
                        </div>
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Satır İçi Form</h2>
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
