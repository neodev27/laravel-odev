...
@section('subhead')
    <title>Panel - Midone - Tailwind HTML Yönetici Şablonu</title>
@endsection
            ...
            <div class="col-span-12 xl:col-span-9 2xl:col-span-9 z-10">
                <div class="mt-6 -mb-6 intro-y">
                    <div class="alert alert-dismissible show box bg-primary text-white flex items-center mb-6" role="alert">
                        <span>
                            Karşınızda yeni panel! Şuradan Hemen indirin: <a href="https://themeforest.net/item/midone-jquery-tailwindcss-html-admin-template/26366820" class="underline ml-1" target="blank">themeforest.net</a>.
                            <button class="rounded-md bg-white bg-opacity-20 dark:bg-darkmode-300 hover:bg-opacity-30 py-0.5 px-2 -my-3 ml-2">Canlı Görünüm</button>
                        </span>
                ...
                <div class="mt-14 mb-3 grid grid-cols-12 sm:gap-10 intro-y">
                    <div class="col-span-12 sm:col-span-6 md:col-span-4 py-6 sm:pl-5 md:pl-0 lg:pl-5 relative text-center sm:text-left">
                                ...
                                <ul class="dropdown-content">
                                    <li>
                                        <a href="" class="dropdown-item">
                                            <i data-lucide="file-text" class="w-4 h-4 mr-2"></i> Aylık Bildiri
                                        </a>
                                    </li>
                                    <li>
                                        <a href="" class="dropdown-item">
                                            <i data-lucide="file-text" class="w-4 h-4 mr-2"></i> Yıllık Bildiri
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="text-sm 2xl:text-base font-medium -mb-1">
                           Merhaba Angelina, <span class="text-slate-600 dark:text-slate-300 font-normal">tekrar hoşgeldiniz!</span>
                        </div>
                        ...
                        <div class="2xl:flex mt-5 mb-3">
                            ...
                            <div class="mt-5 2xl:flex 2xl:justify-center 2xl:mt-0 2xl:-ml-20 2xl:w-14 2xl:flex-none 2xl:pl-2.5">
                                <div class="font-medium inline-flex bg-success text-white rounded-full px-2 py-1 text-xs 2xl:text-sm 2xl:p-0 2xl:text-success 2xl:bg-transparent 2xl:flex items-center tooltip cursor-pointer 2xl:justify-center" title="Geçen aydan %49 daha fazla">
                                    49% <i data-lucide="chevron-up" class="w-4 h-4 ml-0.5"></i>
                                </div>
                            </div>
                        </div>
                        <div class="text-slate-500">En son 1 saat önce güncellendi</div>
                        <div class="2xl:text-base text-slate-600 dark:text-slate-300 mt-6 -mb-1">
                            Toplam net marj: <a href="" class="underline decoration-dotted underline-offset-4 text-primary dark:text-slate-400">$12,921,050</a>
                        </div>
                    ...
                    <div class="row-start-2 md:row-start-auto col-span-12 md:col-span-4 py-6 border-black border-opacity-10 border-t md:border-t-0 md:border-l md:border-r border-dashed px-10 sm:px-28 md:px-5 -mx-5">
                        ...
                        <div class="mt-10 text-slate-600 dark:text-slate-300">Yıllık bütçenin %35'lik kısmını harcaman gerekiyor.</div>
                        <div class="mt-6">
                            <div class="h-[290px]">
                            ...
                            <div class="tab-pane active" id="active-users" role="tabpanel" aria-labelledby="active-users-tab">
                                <div class="relative mt-8">
                                    ...
                                    <div class="flex flex-col justify-center items-center absolute w-full h-full top-0 left-0">
                                        ...
                                        <div class="text-slate-500 mt-0.5">Aktif Kullanıcılar</div>
                                    </div>
                                </div>
                ...
                <div class="grid grid-cols-12 gap-6 relative intro-y">
                    <div class="col-span-12 sm:col-span-4 xl:col-span-3 px-0 lg:px-6 xl:px-0 2xl:px-6">
                        <div class="flex items-center flex-wrap lg:flex-nowrap gap-3">
                            <div class="sm:w-full lg:w-auto text-lg font-medium truncate mr-auto">Özet Bildiri</div>
                            <div class="py-1 px-2.5 rounded-full text-xs bg-slate-300/50 dark:bg-darkmode-400 text-slate-600 dark:text-slate-300 cursor-pointer truncate">180 Kampanya</div>
                        </div>
                    ...
                    <div class="col-span-12 sm:col-span-4 xl:col-span-3 px-0 lg:px-6 xl:px-0 2xl:px-6">
                        <div class="flex items-center flex-wrap lg:flex-nowrap gap-3">
                            ...
                            <a href="" class="flex items-center text-primary">
                                <div class="truncate 2xl:mr-auto">Detayları Görüntüle</div>
                        ...
                        <div class="flex items-center justify-center mt-10">
                            <div class="text-right">
                                ...
                                <div class="truncate mt-1 text-slate-500">Aktif Lender'lar</div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="truncate mt-1 text-slate-500">Toplam Lender'lar</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-span-12 sm:col-span-4 xl:col-span-3 px-0 lg:px-6 xl:px-0 2xl:px-6">
                        <div class="flex items-center flex-wrap lg:flex-nowrap gap-3">
                            <div class="sm:w-full lg:w-auto text-lg font-medium truncate mr-auto">Gönderilenmiş Reklamlar</div>
                            <div class="py-1 px-2.5 rounded-full text-xs bg-slate-300/50 dark:bg-darkmode-400 text-slate-600 dark:text-slate-300 cursor-pointer truncate">320 Takipçi</div>
                        </div>
                        <div class="px-10 sm:px-0">
                            <div class="h-[110px]">
                        ...
                        <div class="flex flex-wrap gap-3">
                            <div class="mr-auto">
                                <div class="text-white text-opacity-70 dark:text-slate-300 flex items-center leading-3">
                                    AVAILABLE FUNDS
                                    <i data-lucide="alert-circle" class="tooltip w-4 h-4 ml-1.5" title="Satışlarının toplam değeri: $158.409.416"></i>
                                </div>
                    ...
                    <div class="report-box-4__content xl:min-h-0 intro-x">
                        <div class="max-h-full xl:overflow-y-auto box mt-5">
                            <div class="xl:sticky top-0 px-5 pt-5 pb-6">
                                <div class="flex items-center">
                                    <div class="text-lg font-medium truncate mr-5">Özet Bildiri</div>
                                    <a href="" class="ml-auto flex items-center text-primary">
                                        <i data-lucide="refresh-ccw" class="w-4 h-4 mr-3"></i> Yenile
                                    </a>
                                </div>
                                <ul
                                    class="
                                ...
                                <div class="tab-pane active grid grid-cols-12 gap-y-6" id="weekly-report" role="tabpanel" aria-labelledby="weekly-report-tab">
                                    <div class="col-span-12 sm:col-span-6 md:col-span-4 xl:col-span-12">
                                        ...
                                        <div class="mt-1.5 flex items-center">
                                            ...
                                            <div class="text-danger flex text-xs font-medium tooltip cursor-pointer ml-2" title="Geçen aydan %2 daha düşük">
                                                2% <i data-lucide="chevron-down" class="w-4 h-4 ml-0.5"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-span-12 sm:col-span-6 md:col-span-4 xl:col-span-12">
                                        <div class="text-slate-500">Aktif Fon Ortağı</div>
                                        <div class="mt-1.5 flex items-center">
                                            <div class="text-lg">52 Ortak</div>
                                            <div class="text-success flex text-xs font-medium tooltip cursor-pointer ml-2" title="Geçen aydan %0.01 daha düşük">
                                                49% <i data-lucide="chevron-up" class="w-4 h-4 ml-0.5"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-span-12 sm:col-span-6 md:col-span-4 xl:col-span-12">
                                        ...
                                        <div class="mt-1.5 flex items-center">
                                            ...
                                            <div class="text-success flex text-xs font-medium tooltip cursor-pointer ml-2" title="Geçen aydan %49 daha yüksek">
                                    ...
                                    <div class="col-span-12 sm:col-span-6 md:col-span-4 xl:col-span-12">
                                        <div class="text-slate-500">Ödeme Bekleniyor</div>
                                        <div class="mt-1.5 flex items-center">
                                    ...
                                    <button class="btn btn-outline-secondary col-span-12 border-slate-300 dark:border-darkmode-300 border-dashed relative justify-start mb-2">
                                        <span class="truncate mr-5">Poortfolyo Detaylarım</span>
        ...
        <div class="col-span-12 2xl:col-span-9">
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 mt-6">
                    <div class="intro-y block sm:flex items-center h-10">
                        <h2 class="text-lg font-medium truncate mr-5">Haftalık En Üst Ürünler</h2>
                ...
                <div class="2xl:pl-6 grid grid-cols-12 gap-x-6 2xl:gap-x-0 gap-y-6">
                    ...
                    <div class="col-span-12 md:col-span-6 2xl:col-span-12 mt-3 2xl:mt-6">
                        <div class="intro-x flex items-center h-10">
                            <h2 class="text-lg font-medium truncate mr-5">GFeçmiş Aktiviteler</h2>
                        ...
                        <div class="mt-5 relative before:block before:absolute before:w-px before:h-[85%] before:bg-slate-200 before:dark:bg-darkmode-400 before:ml-5 before:mt-5">
                            ...
                            <div class="intro-x relative flex items-center mb-3">
                                ...
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    ...
                                    <div class="text-slate-500">
                                        <div class="mt-1">3 yeni fotograf ekledi</div>
                                        <div class="flex mt-2">
                            ...
                            <div class="intro-x relative flex items-center mb-3">
                                ...
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    ...
                                    <div class="text-slate-500 mt-1"><a class="text-primary" href="">{{ $fakers[7]['products'][0]['name'] }}</a> fiyatıve açıklamayı değiştirdi.</div>
                                </div>
                            </div>
                            <div class="intro-x relative flex items-center mb-3">
                                <div class="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                ...
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    ...
                                    <div class="text-slate-500 mt-1"><a class="text-primary" href="">{{ $fakers[6]['products'][0]['name'] }}</a> açıklamayı değiştirdi</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-6 2xl:col-span-12 mt-3">
                        ...
                        <div class="mt-5">
                            ...
                            @endforeach
                            <a href="" class="intro-y w-full block text-center rounded-md py-4 border border-dotted border-slate-400 dark:border-darkmode-300 text-slate-500">Daha Fazla Göster</a>
                        </div>
                    </div>
                    <!-- END: Transactions -->
                </div>
