...
@section('subhead')
    <title>Dosya Yükle - Midone - Tailwind HTML Admin Template</title>
@endsection

@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Bırakma Noktası</h2>
    </div>
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Tek Dosya Yükle</h2>
                    ...
                    <div class="preview">
                        <form data-single="true" action="/file-upload" class="dropzone">
                            ...
                            <div class="dz-message" data-dz-message>
                                <div class="text-lg font-medium">Dosyanızı buraya sürükleyin yada yükleme için buraya tıklayın.</div>
                                <div class="text-slate-500">
                                    Bu sadece bir demo bırakma noktasıdır. Seçilen dosyalar ayrıca <span class="font-medium">yüklenmedi</span>
                                </div>
                            </div>
                        </form>
                    </div>
                                ...
                                <code class="html">
                                    {{ str_replace('>', 'HTMLCloseTag', str_replace('<', 'HTMLOpenTag', '
                                        <form data-single="true" action="/file-upload" class="dropzone">
                                            ...
                                            <div class="dz-message" data-dz-message>
                                                <div class="text-lg font-medium">Dosyaları buraya sürükleyin veya yüklemek için buraya tıklayın.</div>
                                                <div class="text-slate-500">
                                                    Bu sadece bir demo bırakma noktasıdır. Seçilen dosyalar ayrıca <span class="font-medium">yüjkklenmedi</span>
                                                </div>
                                            </div>
                                        </form>
                                    ')) }}
                ...
                <div id="multiple-file-upload" class="p-5">
                    <div class="preview">
                        <form action="/file-upload" class="dropzone">
                            ...
                            <div class="dz-message" data-dz-message>
                                <div class="text-lg font-medium">Dosyayı buraya sürükleyin veya yüklemek için buraya tıklayın .</div>
                                <div class="text-slate-500">
                                    Bu sadece bir demo bırakma noktasıdır. Seçilen dosyalar ayrıca <span class="font-medium">yüklenmedi.</span>
                                </div>
                            </div>
                                ...
                                <code class="html">
                                    {{ str_replace('>', 'HTMLCloseTag', str_replace('<', 'HTMLOpenTag', '
                                        <form action="/file-upload" class="dropzone">
                                            ...
                                            <div class="dz-message" data-dz-message>
                                                <div class="text-lg font-medium">Dosyayı buraya bırakın veya yüklemek için buraya dokunun.</div>
                                                <div class="text-slate-500">
                                                    Bu sadece bir demo bırakma noktasıdır. Seçilen dosyalar ayrıca  <span class="font-medium">yüklenmedi.</span>
                                                </div>
                                            </div>
        ...
        <div class="intro-y col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Dosya Türü Doğrulaması</h2>
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                        <label class="form-check-label ml-0" for="show-example-3">Örnek kodu kopyalama</label>
