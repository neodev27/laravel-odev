...
@section('subhead')
    <title>CRUD Veri Listesi - Midone - Tailwind HTML Yönetici Şablonu</title>
@endsection

@section('subcontent')
    <h2 class="intro-y text-lg font-medium mt-10">Veri Listesi Görünümü</h2>
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <button class="btn btn-primary shadow-md mr-2">Yeni Ürün Ekle</button>
            <div class="dropdown">
                ...
                <div class="dropdown-menu w-40">
                    <ul class="dropdown-content">
                        ...
                        <li>
                            <a href="" class="dropdown-item">
                                <i data-lucide="file-text" class="w-4 h-4 mr-2"></i> Excel'e Çıkar
                            </a>
                        </li>
                        <li>
                            <a href="" class="dropdown-item">
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        <th class="whitespace-nowrap">RESİM</th>
                        ...
                        <th class="text-center whitespace-nowrap">JHAREKETLER</th>
                    </tr>
                </thead>
                <tbody>
            ...
            <div class="modal-content">
                <div class="modal-body p-0">
                    <div class="p-5 text-center">
                        ...
                        <div class="text-slate-500 mt-2">Bu kayıtları silmek istediğinizden emin misiniz? <br>Bu işlem geri alınamaz.</div>
                    </div>
