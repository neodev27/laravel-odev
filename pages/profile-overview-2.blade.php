        ...
        <div class="flex flex-col lg:flex-row border-b border-slate-200/60 dark:border-darkmode-400 pb-5 -mx-5">
            ...
            <div class="mt-6 lg:mt-0 flex-1 flex items-center justify-center px-5 border-t lg:border-0 border-slate-200/60 dark:border-darkmode-400 pt-5 lg:pt-0">
                ...
                <div class="text-center rounded-md w-20 py-3">
                    ...
                    <div class="text-slate-500">Ödemeler</div>
                </div>
                <div class="text-center rounded-md w-20 py-3">
                    <div class="font-medium text-primary text-xl">492</div>
                    <div class="text-slate-500">Ön Gösterimler</div>
                </div>
            </div>
        </div>
        <ul
        ...
        >
            <li id="profile-tab" class="nav-item" role="presentation">
                <a
                    ...
                    role="tab"
                >
                    <i class="w-4 h-4 mr-2" data-lucide="user"></i> Profil
                </a>
            </li>
            <li id="account-tab" class="nav-item" role="presentation">
                <a
                    ...
                    role="tab"
                >
                    <i class="w-4 h-4 mr-2" data-lucide="shield"></i> Hesap
                </a>
            </li>
            <li id="change-password-tab" class="nav-item" role="presentation">
                <a
                    ...
                    role="tab"
                >
                    <i class="w-4 h-4 mr-2" data-lucide="lock"></i> Şifreyi Değiştir
                </a>
            </li>
            <li id="settings-tab" class="nav-item" role="presentation">
                <a
                    ...
                    role="tab"
                >
                    <i class="w-4 h-4 mr-2" data-lucide="settings"></i> Ayarlar
                </a>
            </li>
        </ul>
    </div>
            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="intro-y box col-span-12 lg:col-span-6">
                    <div class="flex items-center px-5 py-5 sm:py-3 border-b border-slate-200/60 dark:border-darkmode-400">
                        <h2 class="font-medium text-base mr-auto">En SOn Yüklemeler</h2>
                        <div class="dropdown ml-auto sm:hidden">
                            ...
                            <div class="dropdown-menu w-40">
                                <ul class="dropdown-content">
                                    <li>
                                        <a href="javascript:;" class="dropdown-item">Tüm Dosyalar</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <button class="btn btn-outline-secondary hidden sm:flex">Tüm Dosyalar</button>
                    </div>
                    <div class="p-5">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <a class="font-medium" href="">Belgeleme</a>
                                    ...
                                    <ul class="dropdown-content">
                                        <li>
                                            <a href="" class="dropdown-item">
                                                <i data-lucide="users" class="w-4 h-4 mr-2"></i> Dosya Paylaş
                                            </a>
                                        </li>
                                        <li>
                                            <a href="" class="dropdown-item">
                        ...
                        <div class="flex items-center mt-5">
                            ...
                            <div class="ml-4">
                                <a class="font-medium" href="">Kaynaklar</a>
                ...
                <div class="intro-y box col-span-12 lg:col-span-6">
                    <div class="flex items-center px-5 py-5 sm:py-0 border-b border-slate-200/60 dark:border-darkmode-400">
                        <h2 class="font-medium text-base mr-auto">Süreçte olan çalışmalar</h2>
                        <div class="dropdown ml-auto sm:hidden">
                            <a class="dropdown-toggle w-5 h-5 block" href="javascript:;" aria-expanded="false" data-tw-toggle="dropdown">
                                <i data-lucide="more-horizontal" class="w-5 h-5 text-slate-500"></i>
                            </a>
                    ...
                    <div class="p-5">
                        <div class="tab-content">
                            <div id="work-in-progress-new" class="tab-pane active" role="tabpanel" aria-labelledby="work-in-progress-new-tab">
                                ...
                                <div class="mt-5">
                                    <div class="flex">
                                        <div class="mr-auto">Tamamlanmış Görevler</div>
                                        <div>2 / 20</div>
                                    </div>
                                    <div class="progress h-1 mt-2">
                                ...
                                <div class="mt-5">
                                    <div class="flex">
                                        <div class="mr-auto">Süreçte olan görevler</div>
                                        <div>42</div>
                                    </div>
                                    <div class="progress h-1 mt-2">
                ...
                <div class="intro-y box col-span-12">
                    <div class="flex items-center px-5 py-3 border-b border-slate-200/60 dark:border-darkmode-400">
                        <h2 class="font-medium text-base mr-auto">Yeni Ürünler</h2>
                            ...
                            <div class="px-5">
                                ...
                                <div class="flex flex-col sm:flex-row items-center border-t border-slate-200/60 dark:border-darkmode-400 pt-5">
                                    ...
                                    <div class="flex sm:ml-auto mt-5 sm:mt-0">
                                        <button class="btn btn-secondary w-20 ml-auto">Ön Gösterim</button>
                                        <button class="btn btn-secondary w-20 ml-2">Detaylar</button>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                ...
                <div class="intro-y box col-span-12">
                    <div class="flex items-center px-5 py-3 border-b border-slate-200/60 dark:border-darkmode-400">
                        <h2 class="font-medium text-base mr-auto">Yeni Yetkililer</h2>
                        ...
                        @foreach (array_slice($fakers, 0, 5) as $faker)
                            <div class="px-5">
                                ...
                                <div class="flex flex-col sm:flex-row items-center border-t border-slate-200/60 dark:border-darkmode-400 pt-5">
                                    <div class="w-full sm:w-auto flex justify-center sm:justify-start items-center border-b sm:border-b-0 border-slate-200/60 dark:border-darkmode-400 pb-5 sm:pb-0">
                                        <div class="px-3 py-2 text-primary bg-primary/10 dark:bg-darkmode-400 dark:text-slate-300 rounded font-medium mr-3">{{ $faker['dates'][0] }}</div>
                                        <div class="text-slate-500">Katıldığı Tarih</div>
                                    </div>
                                    <div class="flex sm:ml-auto mt-5 sm:mt-0">
                                        <button class="btn btn-secondary w-20 ml-auto">Mesaj</button>
                                        <button class="btn btn-secondary w-20 ml-2">Profil</button>
                                    </div>
                                </div>
                            </div>
                        @endforeach
